...
namespace m540
{
	...
	public class Triangle
	{
		...
		public static Triangle FromFacet(Facet f)
		{
			return new Triangle(ProjectXY(f.V1),ProjectXY(f.V2),ProjectXY(f.V3));
		}
		public static Pair ProjectXY(Point3 p)
		{
		...
		public bool Contains(Pair p)
		{
			...
			return Math.Abs(twice_area - sum) < 1e-10; 
		}
