  ...
  public class ModelNode
	{
		...
		private List<int> adj_indices;
		public List<int> AdjacencyIndices
		{
			get {return adj_indices;}
		}
		...
		public Vector3 CurrentVelocity {get {return current_velocity;} set {current_velocity = value;}}
		public Vector3 LastVelocity {get {return previous_velocity;} set {previous_velocity = value;}}
		public string ToSaveString()
		{
			string output = current_location.X.ToString() + "," + current_location.Y.ToString() + "," + current_location.Z.ToString();
			return output; //+ "," + on_boundary.ToString();
		}
	...
	public class Adjacency
	{
		...
		public int GetRelevantIndex(int exclude)
		{
			if (exclude == rootindex) return endindex;
			else return rootindex;
		}
		...
		public string ToDescriptionString()
		{
			string output = "RootIndex = " + rootindex + ", ";
			output += "EndIndex = " + endindex + ", ";
			output += "SpringConstant = " + spring_constant.ToString(); 
			return output;
		}
		public void Break()
		{
